            ...
            <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img width="100px" height="100px" src="{{ asset($items->student_image) }}" alt="image">
                        </td>
                        <td>
                            <a href="{{ route('student.edit', $items->id) }}" class="btn btn-success">Edit</a>
                            <a href="{{ route('student.show', $items->id) }}" class="btn btn-info">Show</a>
                            <a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modaldemo8">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
