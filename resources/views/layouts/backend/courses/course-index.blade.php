            ...
            <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $items->status ?? 'Inactive'}}</td>
                        <td>{{ $items->start_date }}</td>
                        <td>
                            <img width="100px" height="100px" src="{{ asset($items->thumbnail) }}" alt="image">
                        </td>
                        <td>
                            <a href="{{ route('courses.edit', $items->id) }}" class="btn btn-success">Edit</a>
                            <a href="{{ route('courses.show', $items->id) }}" class="btn btn-info">Show</a>
